...
*   **Signers**&#x20;
    ...
    * **rg** (string): Número do RG do signatário. Diferente do `cpf`, esse campo aceita qualquer valor em qualquer formato — a API não faz validação de formato nem dígito verificador.
