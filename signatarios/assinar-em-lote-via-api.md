...
| signer\_tokens\[]                             | array  | Tokens que serão assinados (token do signer em cada documento a ser assinado).                                          |
